 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3[, E4]]]]
 */
#define DEFAULT_MAX_ACCELERATION      { 300, 300, 10, 400 }
 ...
 */
#define DEFAULT_XJERK                  8.0	// [Need to be adjusted]
#define DEFAULT_YJERK                  3.0	// [Need to be adjusted]
#define DEFAULT_ZJERK                  0.3	// [Need to be adjusted]
#define DEFAULT_EJERK                  6.0	// [Need to be adjusted]
...
#define MIN_PROBE_EDGE 15	// [Need to be adjusted]
 ...
 */
//#define FILAMENT_RUNOUT_SENSOR     // [Does it possible/mandatory to enable this option if filament runout sensor is connected on MKS TFT28"?]
...
// Homing speeds (mm/m)
#define HOMING_FEEDRATE_XY (50*60)	// [Need to be adjusted]
#define HOMING_FEEDRATE_Z  (4*60)	// [Need to be adjusted]
...
//
#define REVERSE_ENCODER_DIRECTION	// [Need to be checked]
